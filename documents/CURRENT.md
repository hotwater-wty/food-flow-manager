...
后端 V1/V2 核心业务和工程增强已完成并冻结扩张；根目录 `frontend/` 已完成 Vue 3 + TypeScript + Vite 工程初始化，并已接入顾客认证、预约/开台、菜单、购物车、订单创建/列表/详情，以及员工认证、管理端订单/会话工作台和第二批桌位、分类、菜品、预约、员工资料维护工作台。管理端使用独立员工 JWT。当前进入最终数据复验、测试和文档收尾阶段。
